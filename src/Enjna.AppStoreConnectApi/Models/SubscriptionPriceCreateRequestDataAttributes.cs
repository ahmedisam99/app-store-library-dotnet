...
/// <summary>
/// The attributes of the request body that schedules a subscription price.
/// </summary>
/// <seealso href="https://developer.apple.com/documentation/appstoreconnectapi/subscriptionpricecreaterequest/data/attributes"/>
public sealed class SubscriptionPriceCreateRequestDataAttributes
{
    /// <summary>
