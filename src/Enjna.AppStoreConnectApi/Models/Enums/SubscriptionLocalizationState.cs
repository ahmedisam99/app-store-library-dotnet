...
[Obsolete("Apple deprecated the resource this state belongs to in App Store Connect API 4.4.1. SubscriptionLocalizationV2 has no state, so read the SubscriptionVersionState of its version instead.")]
