...
/// <summary>
/// Where an in-app purchase version sits in the App Review workflow.
/// </summary>
/// <remarks>
...
[JsonConverter(typeof(JsonEnumMemberConverter<InAppPurchaseVersionState>))]
public enum InAppPurchaseVersionState
{
    /// <summary>
    ...
    /// <summary>
    /// The version is being edited, so its localizations and images can be added, changed, or removed.
    /// </summary>
